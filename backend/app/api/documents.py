    ...
    if payload.meta_review_run and payload.meta_review_run.comments:
        ...
        for meta_comment in payload.meta_review_run.comments:
            created_meta = models.MetaComment(
                ...
                impact=meta_comment.impact,
                effort=meta_comment.effort,
                confidence=meta_comment.confidence,
                why_now=meta_comment.why_now,
                recommended_change=meta_comment.recommended_change,
                verification_step=meta_comment.verification_step,
                status=meta_comment.status,
                assignee=meta_comment.assignee,
                due_at=meta_comment.due_at,
                rank_score=meta_comment.rank_score,
