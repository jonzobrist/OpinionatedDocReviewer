...
export type SystemConfigRead = {
  ...
  meta_agent_description: string;
  meta_agent_system_prompt: string;
  meta_agent_focus_areas: string;
  meta_agent_tone: string;
  meta_agent_reference_notes: string | null;
  meta_agent_output_format: string;
  meta_agent_output_max_bullets: number;
  meta_agent_output_require_quote_excerpt: boolean;
  meta_agent_output_require_actionable: boolean;
  meta_agent_output_include_severity: boolean;
  meta_agent_examples: string;
  meta_max_directives_per_group: number;
  meta_global_dedupe_threshold: number;
...
export type MetaCommentRead = {
  ...
  status: 'open' | 'planned' | 'in_progress' | 'blocked' | 'resolved' | string;
